...
const LOCALHOST_API_ENDPOINT_BASE = 'http://localhost:3001/jobbook-laravel/api';
...
const API_ENDPOINT = API_ENDPOINT_BASE;
const DATATYPES_ENDPOINT = `${API_ENDPOINT_BASE}/datatypes`;

export { API_ENDPOINT_BASE, DATATYPES_ENDPOINT, API_ENDPOINT };
