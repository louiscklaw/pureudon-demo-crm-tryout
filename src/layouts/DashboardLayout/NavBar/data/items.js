...
const items = [
  ...
  },
  {
    ...
    sub_items: [
      {
        href: `${ENV_PUBLIC_URL}/app/deep-link-test1`,
        icon: BarChartIcon,
        title: 'deep-link-test1',
      },
      {
        href: `${ENV_PUBLIC_URL}/app/deep-link-test2`,
        icon: BarChartIcon,
        title: 'deep-link-test2',
      },
    ],
  },
  {
    ...
    sub_items: [
      ...
      {
        href: `${ENV_PUBLIC_URL}/app/deep-link-test3`,
        icon: BarChartIcon,
        title: 'deep-link-test3',
      },
      {
        href: `${ENV_PUBLIC_URL}/app/deep-link-test4`,
        icon: BarChartIcon,
        title: 'deep-link-test4',
      },
      {
        href: `${ENV_PUBLIC_URL}/app/deep-link-test5`,
        icon: BarChartIcon,
        title: 'deep-link-test5',
      },
    ],
  },
  {
